...
OUT = output
TRANS = transforms
SV_XML=$(IN)/clientvirtualization.xml
ESR_XML=$(IN)/esr.xml
TABLE=$(OUT)/clientvirtualization-table.html
SIMPLIFIED=$(OUT)/clientvirtualization-table-reqs.html
SV_HTML=$(OUT)/clientvirtualization.html
ESR_HTML=$(OUT)/clientvirtualization-esr.html
SV_OP_HTML=$(OUT)/clientvirtualization-optionsappendix.html
SV_RELEASE_HTML=$(OUT)/clientvirtualization-release.html
